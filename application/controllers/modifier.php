...
class Modifier_Controller extends Base_Controller {

	public $restful = true;

	public function get_index() {
		
		return View::make('modifier.index');
	}
	...
	public function get_search() {
		...
		if (Request::ajax()) {
			...
			foreach ($songs as $song) {
				...
				$html_file_link = addslashes(dkHelpers::get_folder_prefix($song->filename).'/'.rawurlencode($song->filename));		
