...
buttons+="<a data-handler='"+i+"' class='btn "+_class+"' href='javascript:;'>"+icon+""+label+"</a>";callbacks[i]=callback;}
var parts=["<div class='bootbox modal'>"];if(options['header']){var closeButton='';if(typeof options['headerCloseButton']=='undefined'||options['headerCloseButton']){closeButton="<a href='javascript:;' class='close'>&times;</a>";}
